...
class AboutSymbols < Neo::Koan
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      ...
      # http://stackoverflow.com/questions/5358727/ruby-koan-constants-become-symbols
      # Should be true, but the RubyConstant is evaluated after this function
      # def and will not be in the constants
